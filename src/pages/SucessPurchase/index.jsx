  ...
  useEffect(() => {
    ...
    if (stateParam) {
      ...
      const credits = stateData.credits;
        ...
        const infoC = {
          text: `You purchased the plan and received ${credits} credits`,
          type: "increase",
          date: formattedDate,
          credits: credits,
        };
      ...
      <Grid container rowSpacing={1} columnSpacing={{ xs: 1, sm: 2, md: 3 }}>       
        <Grid item xs={toggleDrawer ? 10 : 11} container alignItems="center">
          <Content>
            ...
            <div>
              You received access to All the benefits of the purchased plan plus
              some credits, check your e-mail to see your receipt and click on
